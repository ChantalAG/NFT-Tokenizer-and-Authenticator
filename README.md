...
Case 1: Anyone could create a similar NFT by copying the  attributes of the original NFT and only chnage the account address and pretend to be the original creator of the NFT.
